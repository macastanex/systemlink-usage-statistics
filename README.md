...
This app was generated by `slcli webapp new systemlink-usage-statistics` as a hosted Angular 20 starter for SystemLink.
...
home, datasets, assets, master-detail, operations, settings
...
```bash
slcli webapp publish dist/systemlink-usage-statistics --name "Systemlink Usage Statistics"
```
